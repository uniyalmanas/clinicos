  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-semibold uppercase tracking-wider">Today&apos;s Footfall</span>
            <div className="rounded-lg bg-teal-50 p-2 text-brand-600 dark:bg-teal-950 dark:text-brand-300">
              <Users className="h-4 w-4" />
            </div>
          </div>
          <div className="mt-3 text-3xl font-black text-slate-900 dark:text-white">
            14 <span className="text-xs font-normal text-slate-500">Patients</span>
          </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-semibold uppercase tracking-wider">In Waiting Queue</span>
            <div className="rounded-lg bg-amber-50 p-2 text-amber-600 dark:bg-amber-950 dark:text-amber-300">
              <Clock className="h-4 w-4" />
            </div>
          </div>
          <div className="mt-3 text-3xl font-black text-slate-900 dark:text-white">
            3 <span className="text-xs font-normal text-slate-500">In Waiting Area</span>
          </div>
          <div className="mt-2 text-xs text-slate-500">
            Avg. wait time: <strong className="text-slate-700 dark:text-slate-300">11 mins</strong>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="mt-2 flex items-center gap-2 text-xs text-slate-500">
            <span className="text-emerald-600 font-semibold">₹6,000 UPI</span>
            <span>•</span>
            <span className="text-slate-600 font-semibold">₹1,800 Cash</span>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-semibold uppercase tracking-wider">Estimated Net Margin</span>
            <div className="rounded-lg bg-purple-50 p-2 text-purple-600 dark:bg-purple-950 dark:text-purple-300">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* Chamber 1 */}
        <div className="rounded-2xl border border-teal-200 bg-white p-6 shadow-sm dark:border-teal-950 dark:bg-slate-900">
          <div className="flex items-start justify-between">
            <div>
              <span className="rounded-full bg-teal-50 px-2.5 py-0.5 text-xs font-bold text-teal-700 dark:bg-teal-950 dark:text-teal-300">
                Chamber 1 • Dermatology
              </span>
              <h3 className="mt-2 text-lg font-black text-slate-900 dark:text-white">Dr. Rahul Sharma</h3>
              <p className="text-xs text-slate-500">MD (Derm) • NMC Reg: UKMC-8942-2012</p>
            </div>
            <span className="flex items-center gap-1.5 rounded-full bg-emerald-50 px-2.5 py-1 text-xs font-bold text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300">
          ...
          <div className="mt-4 flex gap-2">
            <Link
              ...
              className="flex-1 rounded-xl bg-brand-600 py-2.5 text-center text-xs font-bold text-white shadow-sm hover:bg-brand-700 transition"
            >
              Open Consultation Pad ℞
            </Link>
            <Link
              href="/dashboard/chambers"
              className="rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
            >
              View Chamber Queue
            </Link>
          </div>
        ...
        {/* Chamber 2 */}
        <div className="rounded-2xl border border-blue-200 bg-white p-6 shadow-sm dark:border-blue-950 dark:bg-slate-900">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500">MDS (Endodontics) • UDC-4120-2016</p>
            </div>
            <span className="flex items-center gap-1.5 rounded-full bg-emerald-50 px-2.5 py-1 text-xs font-bold text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300">
              <span className="h-2 w-2 rounded-full bg-emerald-500 animate-ping"></span>
              Consulting Now
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900 overflow-hidden">
        <div className="p-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500">Real-time status across both consulting chambers</p>
          </div>
          <Link
            href="/dashboard/desk"
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {activeQueue.map((pt) => (
                <tr key={pt.token} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition">
                  ...
                  <td className="px-6 py-3.5">
                    <span className={`inline-block font-semibold text-[11px] ${
                      pt.payment.includes("Paid") ? "text-emerald-600" : "text-amber-600"
                    }`}>
                      ₹{pt.fee} • {pt.payment}
                    </span>
                  </td>
                  <td className="px-6 py-3.5 text-right">
                    <Link
                      ...
                      className="inline-flex items-center gap-1 rounded-lg bg-slate-100 px-2.5 py-1 text-[11px] font-semibold text-slate-700 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-300"
                    >
